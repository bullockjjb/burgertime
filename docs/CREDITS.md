...
The original BurgerTime C++/SFML implementation was made by:
...
Their original source, license, and README remain available. The browser game is a new JavaScript implementation inspired by the platform-and-assembly mechanic. Browser code is offered under GPL-3.0-or-later.
